...
a <- load("~/Documents/R/AlistairMcNairSenior-Miss_SD_Sim-4b9f041/R/Simulation_MLMA_NA.Rdata")
b <- load("~/Documents/R/AlistairMcNairSenior-Miss_SD_Sim-4b9f041/Rdata/agg_results_mlma.Rdata")
b
